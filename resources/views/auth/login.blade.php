...
<head>
    ...
    <style>
        ...
        input:focus {
            ...
            box-shadow: 0 0 0 3px rgba(0,120,193,0.12) !important;
        }
...
<body class="min-h-screen flex items-center justify-center
    ...
    {{-- CARD --}}
    <div class="card-animate relative z-10 w-full max-w-[420px]
        ...
        <div class="relative overflow-hidden px-8 pt-8 pb-7 text-center"
            ...
            {{-- Logo ring --}}
            <div class="relative z-10 w-16 h-16 mx-auto mb-4 rounded-full
        ...
        <div class="px-7 py-7 sm:px-8">
            ...
            <form action="/login" method="POST" class="space-y-4">
                ...
                <div>
                    <label for="login"
                           class="block text-[11px] font-bold text-slate-400
                    ...
                    <div class="relative">
                        <span class="absolute left-3.5 top-1/2 -translate-y-1/2
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-4.5 h-4.5 w-[18px] h-[18px]"
                        ...
                        <input type="text"
                               ...
                               class="w-full h-12 pl-10 pr-4 rounded-xl text-sm
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="password"
                               ...
                               class="w-full h-12 pl-10 pr-11 rounded-xl text-sm
                                      text-slate-800 border border-slate-200
                                      bg-slate-50 transition-all duration-200"
                               style="font-family: 'Plus Jakarta Sans', sans-serif;">
                        <button type="button"
                                class="eye-btn absolute right-3.5 top-1/2 -translate-y-1/2
                                       text-slate-400 p-0.5"
                ...
                {{-- Tombol Masuk --}}
                <button type="submit"
                        class="btn-login w-full h-12 rounded-xl
                               text-white text-sm font-bold tracking-wide
                               border-0 cursor-pointer mt-1"
                        style="background: linear-gradient(135deg, #0D2B6B, #0078C1);
            ...
            <p class="text-center text-sm text-slate-400">
                ...
                <a href="{{ route('register') }}"
                   class="font-bold transition-colors duration-150"
                   style="color: #FD4BC7;">
                    Registrasi
                </a>
            </p>
